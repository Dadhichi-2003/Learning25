...
function Navbar() {
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <Link class="nav-item nav-link" to="/formdemo8">FormDemo8</Li nk> */}
      
      <Link class="nav-item nav-link" to="/useeffect">USE-EFFECT</Link>
      <Link class="nav-item nav-link" to="/apidemo2">APi-demo-2</Link>
      <Link class="nav-item nav-link" to="/apidemo3">APi-demo-3</Link>
